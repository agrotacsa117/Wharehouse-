            ...
            <div class="card-header bg-white">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control form-control-sm" id="filterProduct" placeholder="Buscar producto...">
                    </div>
                    <div class="col-md-3">
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <input type="number" class="form-control" id="editLevel" name="level" min="1" required>
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="row g-3 mt-2">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Fecha Caducidad <span class="text-danger">*</span></label>
                            <input type="date" class="form-control" id="editExpiration" name="expiration_date" required>
                        </div>
                    </div>

                    <div class="mt-3">
                        <label class="form-label fw-semibold">Razón del ajuste <span class="text-danger">*</span></label>
            ...
            <form id="transferForm">
                <div class="modal-body">
                    <div class="alert alert-info">
                        <strong>Producto:</strong> <span id="transferProductName"></span>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            <label class="form-label fw-semibold">Cantidad a Transferir <span class="text-danger">*</span></label>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Nivel <span class="text-danger">*</span></label>
                            <input type="number" class="form-control" id="transferLevel" name="level" min="1" required>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label fw-semibold">Lote <span class="text-danger">*</span></label>
                    ...
                    <div class="mt-3">
                        <label class="form-label fw-semibold">Razón de la transferencia <span class="text-danger">*</span></label>
...
<script>
    ...
    function renderTable(data) {
        ...
        tbody.innerHTML = data.map((item, index) => {
            ...
            return `
                <tr data-warehouse-id="${item.warehouse_id}" data-product="${item.product_id}" data-state="${state}">
                    <td class="text-center text-muted">${index + 1}</td>
                    <td class="fw-medium">${item.product_id || 'N/A'}</td>
                    <td><span class="badge bg-secondary">${item.warehouses_name || item.warehouse?.warehouses_name || 'N/A'}</span></td>
    ...
    function filterTable() {
        ...
        filteredData = inventoryData.filter(item => {
            ...
            if (productFilter && !(item.product_id || '').toLowerCase().includes(productFilter)) return false;
    ...
    function openEditModal(id) {
        ...
        document.getElementById('editProductId').value = item.product_id || 'N/A';
        document.getElementById('editWarehouse').value = item.warehouses_name || item.warehouse?.warehouses_name || 'N/A';
        document.getElementById('editRack').value = item.rack || '';
        document.getElementById('editLevel').value = item._level || 1;
        document.getElementById('editLot').value = item.lot_number || '';
        document.getElementById('editQuantity').value = item.quantity;
        document.getElementById('editExpiration').value = formatDateForInput(item.expiration_date);
        document.getElementById('editReason').value = '';

        document.getElementById('originalExpiration').value = item.expiration_date;
        document.getElementById('originalQuantity').value = item.quantity;
        document.getElementById('originalRack').value = item.rack || '';
        document.getElementById('originalLevel').value = item._level || 1;
        document.getElementById('originalLot').value = item.lot_number || '';
    ...
    function openTransferModal(id) {
        ...
        document.getElementById('transferProductName').textContent = item.product_id || 'N/A';
        document.getElementById('transferAvailableStock').textContent = formatNumber(item.quantity);
        document.getElementById('transferFromWarehouse').textContent = item.warehouses_name || item.warehouse?.warehouses_name || 'N/A';
        ...
        document.getElementById('transferLevel').value = item._level || 1;
        document.getElementById('transferLot').value = item.lot_number || '';
