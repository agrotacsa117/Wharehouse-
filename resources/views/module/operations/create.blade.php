...
<div class="form-card">
    ...
    <!-- ===== Form ===== -->
    <form id="warehouseInventoryForm" class="form-body" novalidate>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <select
                    class="form-select tacsa-select"
                    id="productId"
                    name="productId"
                    required
                >
                    <option value="" disabled selected>Seleccione un producto</option>
                    <option value="1">Producto A - Harina de trigo</option>
                    <option value="2">Producto B - Azucar refinada</option>
                    <option value="3">Producto C - Aceite vegetal</option>
                    <option value="4">Producto D - Leche en polvo</option>
                    <option value="5">Producto E - Sal de mesa</option>
                </select>
            ...
            <div class="col-md-6">
                ...
                >
                    ...
                    <option value="1">ALM001 - Almacen Central</option>
                    <option value="2">ALM002 - Almacen Norte</option>
                    <option value="3">ALM003 - Almacen Sur</option>
                    <option value="4">ALM004 - Almacen Oriente</option>
                </select>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input
                    type="text"
                    class="form-control tacsa-input"
                    id="rack"
                    name="rack"
                    placeholder="Ej: R-01, R-02"
                    required
                >
            </div>
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input
                    ...
                    id="reason"
                    name="reason"
                    placeholder="Ej: Entrada de mercancia, Ajuste de inventario"
                    required
                >
            </div>
        </div>
