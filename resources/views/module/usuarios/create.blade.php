                ...
                <div class="col-lg-7 col-xl-6">
                    <div class="card shadow border-0">
                        ...
                        <div class="card-body bg-white">
                            ...
                            @endif
                            <p class="mb-4 text-muted fs-6">Complete los campos para registrar un nuevo usuario en el
                                sistema.</p>
                            <form action="{{ route('usuarios.store') }}" method="POST">
                                ...
                                <div class="mb-4">
                                    ...
                                    <select name="rol" id="rol" class="form-select" required>
                                        ...
                                        @foreach ($rols as $rol)
                                            <option value="{{ json_encode(['id' => $rol->getId(), 'name' => $rol->getRoleName()])}}">{{ $rol->getRoleName() }}</option>
                                        @endforeach
                                    </select>
                                </div>
