            ...
            <div class="form-container">
                ...
                <form method="POST" action="{{ route('warehouses.store') }}" id="warehouseForm" novalidate>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="tel" id="telefono" name="phone_number" placeholder="10 dígitos" required
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                <select id="headquarters" name="location_id" required>
                    ...
                    <div class="form-section">
                        ...
                        <div class="form-section conditional-section" id="condiciones-section">
                            ...
                            <div class="info-box">
                                Los campos de temperatura son obligatorios para almacenes refrigerados o congelados. Los
                                campos de humedad son opcionales.
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="temperatura_min" name="temperatura_min"
                                        placeholder="Ej: -18" step="0.1">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="temperatura_max" name="temperatura_max"
                                        placeholder="Ej: -15" step="0.1">
                            ...
                            <div class="form-row">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="humedad_min" name="humedad_min" placeholder="Ej: 40"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" id="humedad_max" name="humedad_max" placeholder="Ej: 60"
                                        min="0" max="100" step="0.1">
                                    <span class="error-message">Ingrese un valor entre 0 y 100</span>
                                </div>
                            </div>
